import { getRootSpan, spanToJSON, addNonEnumerableProperty, getIsolationScope, flushIfServerless, winterCGRequestToRequestData, stripUrlQueryAndFragment, SEMANTIC_ATTRIBUTE_HTTP_REQUEST_METHOD, objectify } from '@sentry/core';
import { getClient, getActiveSpan, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, withIsolationScope, continueTrace, getCurrentScope, httpHeadersToSpanAttributes, winterCGHeadersToDict, startSpan, setHttpStatus, getTraceMetaTags, captureException } from '@sentry/node';
