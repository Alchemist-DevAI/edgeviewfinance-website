!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"f02949dfd07fd5f7d10fa5111d990ccb97d3c979"};}catch(e){}}();;{try{(function(){var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="f7906af1-eb3f-4a9d-aa92-fc1fe05e8e6c",e._sentryDebugIdIdentifier="sentry-dbid-f7906af1-eb3f-4a9d-aa92-fc1fe05e8e6c");})();}catch(e){}};import { j as AstroError, al as UnknownContentCollectionError, c as createComponent, am as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, an as renderUniqueStylesheet, ao as renderScriptElement, ap as createHeadAndContent, r as renderComponent, b as createAstro, m as maybeRenderHead, e as addAttribute, d as renderScript, aq as Fragment, f as defineScriptVars, ar as renderSlot, as as renderHead } from './astro/server_DVFDqqUz.mjs';
import 'kleur/colors';
/* empty css                         */
...
import { z } from 'zod';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_BQfe2IAZ.mjs';
import { V as VALID_INPUT_FORMATS, $ as $$Image } from './_astro_assets_BLqOht8q.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_5edHxKHw.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_C3K__tz6.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BLqOht8q.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Cz8pUae2.mjs');
