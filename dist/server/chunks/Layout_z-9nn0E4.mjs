!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"584b4cb146101603c97c3a9f561e6b23da616306"};}catch(e){}}();;{try{(function(){var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="29f964c8-d549-442a-82d0-f816aee66251",e._sentryDebugIdIdentifier="sentry-dbid-29f964c8-d549-442a-82d0-f816aee66251");})();}catch(e){}};import { j as AstroError, al as GetEntryDeprecationError, am as UnknownContentCollectionError, c as createComponent, an as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, ao as renderUniqueStylesheet, ap as renderScriptElement, aq as createHeadAndContent, r as renderComponent, b as createAstro, m as maybeRenderHead, e as addAttribute, d as renderScript, ar as Fragment, f as defineScriptVars, as as renderSlot, at as renderHead } from './astro/server_Djx-43IL.mjs';
import 'kleur/colors';
/* empty css                         */
...
import { z } from 'zod';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_BQ-foNxv.mjs';
import { V as VALID_INPUT_FORMATS, $ as $$Image } from './_astro_assets_gzE14wQt.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_cdVc9-LP.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_B7-w-rNp.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_gzE14wQt.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DreO-Fnc.mjs');
...
const $$Logo = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const MetaData = await getEntryBySlug("site", "meta");
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  } = await getEntryBySlug("site", "header");
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  const FooterData = await getEntryBySlug("site", "footer");
  const {
    logo,
    description,
    mail,
...
const $$MicrosoftClarity = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderTemplate(_a$1 || (_a$1 = __template$1(['<script type="text/javascript">\n    (function(c,l,a,r,i,t,y){\n        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};\n        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;\n        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);\n    })(window, document, "clarity", "script", clarityProjectId);\n  </script>'])))}${renderScript($$result, "/mnt/c/GitHub Repos/evfbs-v2-supabase/4-development-infrastructure/evfbs-agency11-pure/src/components/analytics/MicrosoftClarity.astro?astro&type=script&index=0&lang.ts")}`;
