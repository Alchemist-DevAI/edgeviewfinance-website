...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BKWp4R7J.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_g3KabWOf.mjs');
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "vercel-speed-insights", "vercel-speed-insights", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/mnt/c/GitHub Repos/evfbs-v2-supabase/4-development-infrastructure/evfbs-agency11-pure/node_modules/@vercel/speed-insights/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/mnt/c/GitHub Repos/evfbs-v2-supabase/4-development-infrastructure/evfbs-agency11-pure/node_modules/@vercel/speed-insights/dist/astro/index.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const { title, description: pageDescription } = Astro2.props;
  const MetaData = await getEntry({ collection: "site", id: "meta" });
  const { siteName, description: siteDescription, favicon } = MetaData?.data;
  const description = pageDescription || siteDescription;
  return renderTemplate(_a || (_a = __template(['<html lang="en" data-astro-cid-s6tr6vzr> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>', "", " | ", "", '</title><meta name="description"', '><!-- Preconnect to external domains for performance --><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link rel="preconnect" href="https://assets.calendly.com" crossorigin><link rel="dns-prefetch" href="https://www.googletagmanager.com"><link rel="dns-prefetch" href="https://www.clarity.ms"><!-- Favicon Support for All Browsers --><link rel="icon" type="image/x-icon" href="/favicon.ico"><link rel="icon" type="image/png" sizes="16x16" href="/favicon.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon.png"><link rel="icon" type="image/png" sizes="192x192" href="/android-chrome-192x192.png"><link rel="icon" type="image/png" sizes="512x512" href="/android-chrome-512x512.png"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="icon" type="image/webp"', '><link rel="manifest" href="/site.webmanifest"><!-- International Targeting for Australia --><link rel="alternate" hreflang="en-au"', '><link rel="alternate" hreflang="en"', '><link rel="alternate" hreflang="x-default"', '><!-- Open Graph Meta Tags --><meta property="og:type" content="website"><meta property="og:title"', '><meta property="og:description"', '><meta property="og:url"', '><meta property="og:site_name"', '><meta property="og:locale" content="en_AU"><meta property="og:image"', '><!-- Twitter Card Meta Tags --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"', '><meta name="twitter:description"', '><meta name="twitter:image"', '><!-- Geographic Targeting --><meta name="geo.region" content="AU"><meta name="geo.country" content="Australia"><meta name="geo.placename" content="Australia"><!-- Canonical URL --><link rel="canonical"', "><!-- Preload critical hero image for LCP optimization -->", `<!-- Equipment Finance and Vehicle Finance pages have text-only heroes - no image preload needed --><!-- Critical CSS inlined for LCP --><!-- Force mobile menu submenu styling --><link rel="stylesheet" href="/assets/css/mobile-menu-fix.css"><!-- Calendly widget styling - deferred for performance --><link href="https://assets.calendly.com/assets/external/widget.css" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'">`, '<noscript><link href="https://assets.calendly.com/assets/external/widget.css" rel="stylesheet"></noscript><!-- Google Analytics GA4 - Optimized Component -->', "<!-- Microsoft Clarity - Heatmaps and Session Recording -->", "", "</head> <body data-astro-cid-s6tr6vzr> <div", " data-astro-cid-s6tr6vzr> ", " ", " ", " </div> <!-- Vercel Speed Insights - Real User Monitoring --> ", ` <script src="/assets/js/menu.js"><\/script> <!-- Non-critical scripts - deferred for LCP optimization --> <script src="/assets/js/countdown.js" defer><\/script> <script src="/assets/js/counterup.js" defer><\/script> <script src="/assets/js/main.js" defer><\/script> <!-- Calendly widget script - fully async, non-blocking --> <script src="https://assets.calendly.com/assets/external/widget.js" type="text/javascript" async><\/script> <!-- Analytics Initialization - fully async, non-blocking --> <script type="module" src="/src/scripts/analytics-init.js" async><\/script> <!-- Service Worker Registration - Async, non-blocking --> <script async>
  // Register service worker for offline functionality (after page load)
...
<\/script> <!-- JOS animations disabled for static display --> <!-- <script>
