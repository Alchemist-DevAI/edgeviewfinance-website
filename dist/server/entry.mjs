...
import { manifest } from './manifest_DID5BrpU.mjs';
...
const _page31 = () => import('./pages/locations/sunshine-coast.astro.mjs');
const _page32 = () => import('./pages/locations/toowoomba.astro.mjs');
const _page33 = () => import('./pages/portfolio/_single_.astro.mjs');
const _page34 = () => import('./pages/portfolio.astro.mjs');
const _page35 = () => import('./pages/pricing.astro.mjs');
const _page36 = () => import('./pages/privacy-policy.astro.mjs');
const _page37 = () => import('./pages/service/_single_.astro.mjs');
const _page38 = () => import('./pages/services.astro.mjs');
const _page39 = () => import('./pages/success-stories/equipment-finance-excavator.astro.mjs');
const _page40 = () => import('./pages/success-stories.astro.mjs');
const _page41 = () => import('./pages/team.astro.mjs');
const _page42 = () => import('./pages/terms-condition.astro.mjs');
const _page43 = () => import('./pages/terms-of-use.astro.mjs');
const _page44 = () => import('./pages/test.astro.mjs');
const _page45 = () => import('./pages/test-sentry.astro.mjs');
const _page46 = () => import('./pages/vehicle-finance.astro.mjs');
const _page47 = () => import('./pages/working-capital-finance.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/locations/sunshine-coast.astro", _page31],
    ["src/pages/locations/toowoomba.astro", _page32],
    ["src/pages/portfolio/[single].astro", _page33],
    ["src/pages/portfolio/index.astro", _page34],
    ["src/pages/pricing.astro", _page35],
    ["src/pages/privacy-policy.astro", _page36],
    ["src/pages/service/[single].astro", _page37],
    ["src/pages/services.astro", _page38],
    ["src/pages/success-stories/equipment-finance-excavator.astro", _page39],
    ["src/pages/success-stories.astro", _page40],
    ["src/pages/team.astro", _page41],
    ["src/pages/terms-condition.astro", _page42],
    ["src/pages/terms-of-use.astro", _page43],
    ["src/pages/test.astro", _page44],
    ["src/pages/test-sentry.astro", _page45],
    ["src/pages/vehicle-finance.astro", _page46],
    ["src/pages/working-capital-finance.astro", _page47],
...
const _args = {
    "middlewareSecret": "0d514cfb-463e-4ed2-ab20-6584c9854b96",
