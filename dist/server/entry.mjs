...
import { manifest } from './manifest_0mZV4oO_.mjs';
...
const _page34 = () => import('./pages/portfolio/_single_.astro.mjs');
const _page35 = () => import('./pages/portfolio.astro.mjs');
const _page36 = () => import('./pages/pricing.astro.mjs');
const _page37 = () => import('./pages/privacy-policy.astro.mjs');
const _page38 = () => import('./pages/service/_single_.astro.mjs');
const _page39 = () => import('./pages/services.astro.mjs');
const _page40 = () => import('./pages/success-stories/equipment-finance-excavator.astro.mjs');
const _page41 = () => import('./pages/success-stories.astro.mjs');
const _page42 = () => import('./pages/team.astro.mjs');
const _page43 = () => import('./pages/terms-condition.astro.mjs');
const _page44 = () => import('./pages/terms-of-use.astro.mjs');
const _page45 = () => import('./pages/test.astro.mjs');
const _page46 = () => import('./pages/test-sentry.astro.mjs');
const _page47 = () => import('./pages/vehicle-finance.astro.mjs');
const _page48 = () => import('./pages/working-capital-finance.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/portfolio/[single].astro", _page34],
    ["src/pages/portfolio/index.astro", _page35],
    ["src/pages/pricing.astro", _page36],
    ["src/pages/privacy-policy.astro", _page37],
    ["src/pages/service/[single].astro", _page38],
    ["src/pages/services.astro", _page39],
    ["src/pages/success-stories/equipment-finance-excavator.astro", _page40],
    ["src/pages/success-stories.astro", _page41],
    ["src/pages/team.astro", _page42],
    ["src/pages/terms-condition.astro", _page43],
    ["src/pages/terms-of-use.astro", _page44],
    ["src/pages/test.astro", _page45],
    ["src/pages/test-sentry.astro", _page46],
    ["src/pages/vehicle-finance.astro", _page47],
    ["src/pages/working-capital-finance.astro", _page48],
...
const _args = {
    "middlewareSecret": "aca36326-1150-4906-acc3-addda4ec764d",
