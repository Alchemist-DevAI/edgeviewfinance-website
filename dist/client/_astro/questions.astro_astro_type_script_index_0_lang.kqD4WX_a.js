(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"c5db87f655f0d971c7019e78026100b9063f7cd1"}}catch{}})();try{(function(){var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]="f890816a-12f2-4755-87d1-1134b3413d5b",e._sentryDebugIdIdentifier="sentry-dbid-f890816a-12f2-4755-87d1-1134b3413d5b")})()}catch{}let n=1;const c=5,o={q1:null,q2:null,q3:null,q4:[],q5:null},v=document.getElementById("back-btn"),i=document.getElementById("next-btn"),l=document.getElementById("submit-btn"),w=document.getElementById("question-container"),k=document.getElementById("results-container"),b=document.getElementById("progress-container");function S(){q(),f()}function q(){document.querySelectorAll('input[type="radio"]').forEach(e=>{e.addEventListener("change",L)}),document.querySelectorAll('input[type="checkbox"]').forEach(e=>{e.addEventListener("change",E)}),v?.addEventListener("click",N),i?.addEventListener("click",B),l?.addEventListener("click",R)}function L(e){const t=`q${n}`;o[t]=e.target.value,n===c?l.disabled=!1:i.disabled=!1}function E(e){const t=`q${n}`;e.target.checked?o[t].includes(e.target.value)||o[t].push(e.target.value):o[t]=o[t].filter(s=>s!==e.target.value),i.disabled=o[t].length===0}function N(){n>1&&(document.getElementById(`q${n}`).classList.add("hidden"),n--,document.getElementById(`q${n}`).classList.remove("hidden"),f(),x(),window.scrollTo({top:0,behavior:"smooth"}))}function B(){if(n<c){document.getElementById(`q${n}`).classList.add("hidden"),n++,document.getElementById(`q${n}`).classList.remove("hidden"),f(),x();const e=`q${n}`;n===4?i.disabled=o[e].length===0:i.disabled=!o[e],window.scrollTo({top:0,behavior:"smooth"})}}function x(){if(v.classList.toggle("hidden",n===1),n===c){i.classList.add("hidden"),l.classList.remove("hidden");const e=`q${n}`;l.disabled=!o[e]||o[e]===""}else i.classList.remove("hidden"),l.classList.add("hidden")}function f(){const e=b.querySelector(".bg-orange-500");if(e){const s=n/c*100;e.style.width=`${s}%`}const t=b.querySelector("[data-step-text]");t&&(t.textContent=`Question ${n} of ${c}`)}function C(){let e=0;e+={"fully-current":10,"mostly-current":7,"basic-compliance":4,behind:1}[o.q1]||0,e+={"10m-plus":10,"3m-10m":7,"1m-3m":4,"under-1m":2}[o.q2]||0,e+={"complete-visibility":10,"good-understanding":7,"basic-knowledge":4,"limited-visibility":1}[o.q3]||0;const r=Math.min(10,o.q4.length/9*10);return e+=r,e+={"currently-active":10,"recent-experience":7,"some-time-ago":4,"never-long-ago":1}[o.q5]||0,Math.round(e)}function I(e){return e>=45?{level:"Elite",color:"green"}:e>=35?{level:"Professional",color:"blue"}:e>=25?{level:"Nearly Ready",color:"amber"}:e>=15?{level:"Foundation",color:"orange"}:{level:"Support Needed",color:"red"}}async function R(){if(l.disabled)return;const e=C(),{level:t,color:s}=I(e);sessionStorage.setItem("assessmentScore",e),sessionStorage.setItem("assessmentLevel",t),sessionStorage.setItem("assessmentAnswers",JSON.stringify(o)),w.classList.add("hidden"),b.classList.add("hidden"),k.classList.remove("hidden"),$(e,t,s),window.scrollTo({top:0,behavior:"smooth"})}function $(e,t,s){const a=document.getElementById("score-display"),r={green:"text-green-600",blue:"text-blue-600",amber:"text-amber-600",orange:"text-orange-600",red:"text-red-600"},u={green:"border-green-500",blue:"border-blue-500",amber:"border-amber-500",orange:"border-orange-500",red:"border-red-500"};a.innerHTML=`
